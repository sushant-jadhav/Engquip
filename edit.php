...
if($t1==True && $t2==True && $t3==True && $t4==True ){
  ...
  $query_upload="UPDATE ads SET adHeading='$title',adText='$des',adPrice='$price',adPincode='$pincode',opId='$cat',adStatus='$status',adKey='$key',adCountry='$country',adRegion='$region',adCity='$city',uId='$uid',adImg1='".$target_path1."',adImg2='".$target_path2."',adImg3='".$target_path3."',adImg4='".$target_path4."',adDate='$current_date' 
                where adId=$adsid";
